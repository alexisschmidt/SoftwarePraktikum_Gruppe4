...
"""Realisierung einer exemplarischen Benutzerklasse.
    ...
    Aus Gründen der Vereinfachung besitzt der Dozent in diesem Demonstrator
...
#Auslesen / des Vor/nachnamens und Email.
    ...
    def __str__(self):
        return "Person: {}, {}, {}, {}".format(self.get_id(), self.__firstname, self.__lastname, self.__email,)   

    
    @staticmethod
    def from_dict(dictionary=dict()):
        """Umwandeln eines Python dict() in einen Dozent()."""
        obj = Person()
