...
INSERT INTO `module`(id, creationdate, createdby, name, title, requirement, examtype_hash, outcome, moduletype_hash, ects, edvnr, workload, instructor_hash, module_hash ) VALUES (1,'2022-01-27 10:23:00',3242341,'MODUL MARKETING & ORGANISATION','(MARKETING & ORGANISATION )','-',2314234,'Nach Abschluss des Moduls\nkennen die Studierenden die wichtigsten Grundbegriffe der Disziplinen Marketing und Organisation',3547354,5,546456,'Siehe einzelne Lehrveranstaltung',342357,112313),(2,'2022-01-27 18:00:32',213123,'MODUL GRUNDLAGEN WIRTSCHAFTSINFORMATIK','(FUNDAMENTALS OF INFORMATION SYSTEMS)','-',16347,'Die Studierenden erhalten einen umfassenden Überblick über die Wirtschaftsinformatik, ihre Ziele, Methoden, Konzepte und Kernbegriffe. Dadurch werden die Studierenden befähigt, ein Verständnis für die betriebliche Datenverarbeitung zu entwickeln und die Zusammenhänge zwischen technischen und wirtschaftlichen Aspekten von Informationssystemen zu beurteilen',3547354,5,335121,'5 ECTS= 150 Stunden - Vorlesung: 72h - Vor/Nacharbeit Vorlesung & Klausurvorbereitung: 78h',56673,231345),(3,'2022-01-27 18:00:00',435435112,'GRUNDLAGEN DATENBANKEN','(FUNDAMENTALS OF DATABASES)','-',16347,'Die Studierenden kenne die Grundlagen zur Datenbanktheorie, können die verschiedenen Datenbanktypen unterscheiden. Sie verfügen über die Grundlagen zum Aufbau von einfachen Datenbanken und können diese selbstständig auch praktisch umsetzen.',3547354,5,335122,'Gesamtaufwand: 5 ECTS = 150 Stunden für Vorlesung, Übung und Klausurvorbereitung',12346457,787684234),(4,'2022-01-27 19:06:20',2312312,'MODUL PROGRAMMIEREN','(PROGRAMMING)','-',16347,'Im Rahmen dieses Moduls erlernen die Teilnehmer\nallgemeine technologische Grundlagen von Programmiersprachen\nGrundlagen der Programmierung am Beispiel einer aktuellen, praxisrelevanten Programmiersprache\nObjektorientierte Programmierungmit dem Ziel, eigene Software-Systeme umsetzen zu können.',3547354,5,335123,'15 Termine zu je 2 SWS Vorlesung & 2 SWS Übung: 45 h Kontaktzeit\n15x Vor- und Nachbereitung bzgl. o.g. Termine zu je 7 h: 105 h Selbststudium\nSumme: 150 h (5 ECTS Äquivalent)',56542342456,2132354),(5,'2022-01-27 19:35:00',6767442,'MODUL EXTERNES UND INTERNES RECHNUNGSWESEN','(EXTERNAL AND INTERNAL ACCOUNTING )','-',24534763,'Nach erfolgreicher Teilnahme an der Veranstaltung verfügen die Studierenden über ein fundiertes Basiswissen im Themengebiet Betriebliches Rechnungswesen',3547354,5,335125,'Gesamter Zeitaufwand (Workload) = 150 Zeitstunden',34513123,23423565476),(6,'2022-01-27 20:00:00',32423111,'PROPÄDEUTIK WI','Propädeutik WI','-',16347,'Nach erfolgreichem Besuch des Moduls kennen und verstehen die Studierenden die wesentlichen Grundlagen der Wirtschaftsinformatik und hierbei insbesondere die Grundlagen der quantitativ orientierten betriebswirtschaftlichen Modulen des Studiengangs Wirtschaftsinformatik und digitale Medien.',3547354,5,335126,'	Gesamter Zeitaufwand (Workload) = 150 Zeitstunden',123677876,65768),(7,'2022-01-27 18:23:00',324211234,'DIENSTLEISTUNGSMANAGMENT','(MANAGEMENT OF SERVICES )','-',16347,'Im Modul werden die Grundlagen zum Management von Dienstleistungen vermittelt. Die umfasst a) die Grundlagen des Dienstleistungsmanagement (Definition, Bedeutung, Abgrenzung von Sachgütern, Strategieentscheidungen, Dienstleistungsprozesse, Kundenintegration und -Erlebnisse, Dienstleistungsinnovation) b) die Definition von Qualitätsmerkmalen von Dienstleistungen, Ansätze zu deren Erfassung (Qualitätsmessung) und die Umsetzung im Rahmen von Qualitätsmanagementansätze',3547354,5,335132,'Präsenzzeiten:\n15 Termine zu je 4 SWS = 45 Zeitstunden:\nIndividualarbeit und Gruppenarbeit 60 Zeitstunden\nGesamter Zeitaufwand (Workload) = 150 Zeitstunden',23423476,7867456);
